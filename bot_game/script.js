...
function speed_minus() {
	...
	int = setInterval(random, int_speed);
	document.getElementById('speed').innerHTML = int_speed;
	if (int_speed == 0) {document.getElementById('speed_minus').disabled = true;}
...
function pause() {
		...
		document.getElementById('pause_button').setAttribute('onclick', 'unpause()');
...
function unpause() {
		int = setInterval(random, int_speed);
		document.getElementById('speed').innerHTML = int_speed;
		document.getElementById('pause_button').setAttribute('onclick', 'pause()');
